    ...
    public class Room : MonoBehaviour
    {
        ...
        private void OnDrawGizmos()
        {
            for(int i=0; i<Layout.Count; i++)
            {
                ...
                ConnectionPoint connectionPoints = Layout[i].ConnectionPoint;
        ...
        public ConnectionPoint[,] GetLayout()
        {
            ConnectionPoint[,] layout = new ConnectionPoint[Height, Width];
            for (int i = 0; i < Layout.Count; i++)
            {
            ...
            for(int i=0; i<Height; i++)
            {
                for(int j=0; j<Width; j++)
                {
                    ...
                    else
                    {
                        ...
                        var allPoints = ConnectionPoint.TopMiddle | ConnectionPoint.LeftMiddle | ConnectionPoint.RightMiddle | ConnectionPoint.BottomMiddle;
